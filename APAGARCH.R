...
benchInGarch = function(xtsData, dataName) {
  ...
  mod1 <- garchFit(~ 1 + aparch(1,1), xtsData, trace=FALSE)
  print(paste("#aparch(1,1) #norm #", dataName, seq=""))
  summary(mod1)

  print("----------------------------------------------------------------------------------")
  mod2 <- garchFit(~ 1 + aparch(1,1), xtsData,cond.dist="snorm", trace=FALSE)
  print(paste("#aparch(1,1) #snorm #", dataName, seq=""))
  summary(mod2)

  print("----------------------------------------------------------------------------------")
  mod3 <- garchFit(~ 1 + aparch(1,1), xtsData,cond.dist="std", trace=FALSE)
  print(paste("#aparch(1,1) #std #", dataName, seq=""))
  summary(mod3)

  print("----------------------------------------------------------------------------------")
  mod4 <- garchFit(~ 1 + aparch(1,1), xtsData,cond.dist="sstd", trace=FALSE)
  print(paste("#aparch(1,1) #sstd #", dataName, seq=""))
  summary(mod4)
  print("-----------------------------------------")
  print("#########################################")
  print("####ENDENDENDEDN#########################")
