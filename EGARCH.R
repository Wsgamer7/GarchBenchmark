...
benchInGarch = function(xtsData, dataName) {
  ...
  print(paste("#EGarch(1,1) #norm #", dataName, seq=""))
  show(mod1)
  ...
  print(paste("#EGarch(1,1) #snorm #", dataName, seq=""))
  show(mod2)
  ...
  print(paste("#EGarch(1,1) #std #", dataName, seq=""))
  show(mod3)
  ...
  print(paste("#EGarch(1,1) #sstd #", dataName, seq=""))
  show(mod4)
  print("-----------------------------------------")
  print("#########################################")
